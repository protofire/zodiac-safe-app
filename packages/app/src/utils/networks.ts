...
export const NETWORK_API_URL_BASE: Record<NETWORK, string> = {
  ...
  [NETWORK.FLOW_EVM_MAINNET]: "http://localhost:3001/api",
  [NETWORK.FLOW_EVM_TESTNET]: "http://localhost:3001/api",
}
...
export const NETWORK_MULTI_SEND_CONTRACT: Record<NETWORK, string> = {
  ...
  [NETWORK.FLOW_EVM_MAINNET]: "0xA238CBeb142c10Ef7Ad8442C6D1f9E89e07e7761",
  [NETWORK.FLOW_EVM_TESTNET]: "0xA238CBeb142c10Ef7Ad8442C6D1f9E89e07e7761",
}
